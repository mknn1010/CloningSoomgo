...
@ServerEndpoint("/marketBroadcasting")
public class MarketChatWebSocket {
...
public static Set<Session> setClients = Collections.synchronizedSet(new HashSet<Session>());
	...
	public void onMessage(String message, Session session) throws Exception {
		...
		MarketChatBotDAO mcbDao = new MarketChatBotDAO();
		...
		try {
            ...
            mcbDao.marketChatInsert(roomIdx, usersIdx, content);
