...
<%
	...
	ArrayList<Gosu_zimDto> zdto = (ArrayList<Gosu_zimDto>)request.getAttribute("zdto");
	ArrayList<Gosu_zim_count1Dto> zcdto = (ArrayList<Gosu_zim_count1Dto>)request.getAttribute("zcdto");
        ...
        <div id = "desktop-inner" class = "center">
            ...
            <div class = "app-body">
                ...
                <main class = "app-body-right">
                  ...
                  <% for(Gosu_zimDto gzdto : zdto){ %> 
                  <% for(Gosu_zim_count1Dto gzcdto : zcdto) { %>
                    <div class = "users-main-div1">
                        <div class = "users-main-div2">
                            <div class = "users-main-div3">
                                <div class = "users-main-div4">
                                    ...
                                    <h5 class = "users-main-div4-name"><%=gzdto.getName() %></h5>
                                </div>
                                <p class = "users-main-text"><%=gzdto.getIntro() %></p>
                                <div class = "users-main-stack1">
                                    <div class = "users-main-stack1-1">
                                        ...
                                        <span class = "users-main-stack1-1-span1"><%=gzcdto.getScore() %>.0</span>
                                        <span class = "users-main-stack1-1-span2">(<%=gzcdto.getG_users_idx() %>))</span>
                                    </div>
                            ...
                            <div class = "users-main-div5">
                                <div class = "users-main-div6">
                                    <div idx = "<%=gzdto.getG_users_idx()%>" class = "users-main-div7" style = "background-image: url(<%=gzdto.getF_img()%>);">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class = "users-main-div8">
                            <span class = "users-main-div8-career">경력 <%=gzdto.getCareer() %>년</span>
